...
public class Index extends javax.swing.JFrame {
    ...
    private void btnAcessarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAcessarActionPerformed
        ...
        try{
            ...
            if (usuario == null) {
                JOptionPane.showMessageDialog(rootPane, "Usu·rio e/ou senha incorretos!", "Erro", JOptionPane.ERROR_MESSAGE);
                txtUsuario.setText("");
                jpSenha.setText("");
                txtUsuario.requestFocus();
            } else {
            ...
            JOptionPane.showMessageDialog(null, "Erro na consulta da tabela Usu·rios! " + p.getMessage(), "Erro", JOptionPane.ERROR_MESSAGE);
        }
